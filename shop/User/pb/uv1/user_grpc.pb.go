...
const (
	UserService_UserSignup_FullMethodName = "/uv1.UserService/UserSignup"
	UserService_UserLogin_FullMethodName  = "/uv1.UserService/UserLogin"
)
...
func (c *userServiceClient) UserSignup(ctx context.Context, in *SignupRequest, opts ...grpc.CallOption) (*SignupResponse, error) {
...
func (UnimplementedUserServiceServer) UserSignup(context.Context, *SignupRequest) (*SignupResponse, error) {
